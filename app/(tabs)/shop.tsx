...
import { ActivityIndicator, Image, SafeAreaView, ScrollView, StyleSheet, TextInput, TouchableOpacity, View } from 'react-native';
...
const Shop = () => {
  ...
  return (
    <SafeAreaView>
      ...
      {/* Product Modal with selected product */}
      {selectedProduct && (
        <ProductModal
